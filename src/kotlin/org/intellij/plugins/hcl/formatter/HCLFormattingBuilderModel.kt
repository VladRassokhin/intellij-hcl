...
open class HCLFormattingBuilderModel(val language: Language = HCLLanguage) : FormattingModelBuilder {
  ...
  private fun createSpacingBuilder(settings: CodeStyleSettings): SpacingBuilder {
    ...
    return SpacingBuilder(settings, language)
        ...
        .between(L_CURLY, R_CURLY).spacing(0, 0, 0, false, 0)
        .withinPairInside(L_CURLY, R_CURLY, OBJECT).spacing(1, 0, 1, false, 0)
        ...
        .between(HCLParserDefinition.HCL_COMMENTARIES, HCLParserDefinition.HCL_COMMENTARIES).spacing(0, 0, 1, false, 0)
  }
