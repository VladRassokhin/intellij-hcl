...
class HCLSuppressInspectionFix<out T : PsiElement>(id: String, private val clazz: Class<T>, private val textProvider: (HCLSuppressInspectionFix<T>) -> String)
  : AbstractBatchSuppressByNoInspectionCommentFix(id, false) {

  constructor(id: String, text: String, clazz: Class<T>) : this(id, clazz, {text})
