...
sealed class TerraformFileConfigurationProducer(private val type: Type) : RunConfigurationProducer<TerraformRunConfiguration>(type.factory()) {
  ...
  companion object {
    ...
    fun getModuleTarget(element: PsiElement): Pair<String, String>? {
