...
class ILIntroduceVariableHandler : RefactoringActionHandler {
  companion object {
    ...
    protected fun findOccurrenceUnderCaret(occurrences: List<PsiElement>, editor: Editor): PsiElement? {
    ...
    protected fun findAnchor(occurrence: PsiElement): PsiElement? {
      return findAnchor(listOf(occurrence))
    }

    protected fun findAnchor(occurrences: List<PsiElement>): PsiElement? {
