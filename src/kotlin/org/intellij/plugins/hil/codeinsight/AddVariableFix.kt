...
class AddVariableFix(element: PsiNamedElement, val vName: String = element.name!!) : LocalQuickFixAndIntentionActionOnPsiElement(element) {
  override fun getFamilyName() = "Add variable"
  override fun getText() = "Add variable '$vName'"
